...
def apply_rate_limit(rate="5/minute"):
    ...
    def decorator(func):
        ...
        if os.getenv("TESTING", "false").lower() == "true":
            return func  # Do not apply rate limit in testing environment
...
@router.get("/userinfo", summary="View User Info", response_model=CurrentUserResponse)
...
#     await user.save()
#     return Success(msg="Changed successfully")
