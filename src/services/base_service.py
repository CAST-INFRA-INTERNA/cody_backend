...
class BaseService:
    ...
    async def get_paginated_list(
        ...
        Args:
            ...
            include_m2m: Whether to include many-to-many relations
    ...
    async def get_by_id(
        ...
        exclude_fields: list[str] | None = None,
        include_m2m: bool = False,
        not_found_msg: str = "Record not found",
    ) -> Success:
...
class PermissionService:
    ...
    async def check_superuser(
        user: User, error_msg: str = "Insufficient permissions, superuser required"
    ):
    ...
    async def get_user_agent_ids(user: User) -> set:
        """Get the set of agent IDs the user has access to"""
