...
class FileService:
    """File service class - handles file upload and security validation logic"""
    ...
    def _generate_safe_filename(self, original_filename: str) -> str:
        """Generate a safe filename (prevent path traversal attacks)"""
    ...
    async def _save_file_mapping(
        ...
        try:
            ...
            # File mapping failure should not affect the upload flow
