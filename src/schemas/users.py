...
class UserCreate(BaseModel):
    ...
    password: str = Field(
        ...
        min_length=8,
        description="Password (at least 8 characters, contains letters and numbers)",
    )
    is_active: bool | None = True
    is_superuser: bool | None = False
    ...
    def validate_password_strength(cls, v):
        ...
        #     raise ValueError('Password is recommended to contain special characters')
...
class UpdatePassword(BaseModel):
    ...
    new_password: str = Field(
        min_length=8, description="New password (at least 8 characters, contains letters and numbers)"
    )
