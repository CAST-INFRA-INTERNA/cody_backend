...
async def clean_database():
    ...
    try:
        # Delete all test data (ignore foreign key constraint errors)
        ...
        # If deletion fails, the database may not be initialized — skip
        pass
    ...
    for attempt in range(5):
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"Normal user rate limited, retrying (attempt {attempt + 1}/5)")
                time.sleep(2)
                continue
            else:
